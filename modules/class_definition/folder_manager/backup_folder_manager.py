...
"""
class BackupFolderManager(FolderManagerParent):

    def __init__(self,folder_name:str) -> None:
        folder_path = os.path.join(get_root_folder_path(),"savefiles",folder_name,"BackUp")
        url_path = os.path.join(get_localhost_name(),"savefiles",folder_name,"BackUp")
